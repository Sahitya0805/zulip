...
test("marked", ({ override }) => {
    const test_cases = [
        ...
        },
        {
            input: "mmm...:burrito:s",
            expected:
                '<p>mmm...<img alt=":burrito:" class="emoji" src="/static/generated/emoji/images/emoji/burrito.png" title="burrito" data-tippy-content=":burrito:">s</p>',
        },
        {
            input: "This is an :poop: message",
            expected:
                '<p>This is an <span aria-label="poop" class="emoji emoji-1f4a9" role="img" title="poop" data-tippy-content=":poop:">:poop:</span> message</p>',
        },
        {
            input: "\uD83D\uDCA9",
            expected:
                '<p><span aria-label="poop" class="emoji emoji-1f4a9" role="img" title="poop" data-tippy-content=":poop:">:poop:</span></p>',
        },
        {
        ...
        { input: ":)", expected: "<p>:)</p>" },
        {
            input: ":)",
            expected:
                '<p><span aria-label="slight smile" class="emoji emoji-1f642" role="img" title="slight smile" data-tippy-content=":slight_smile:">:slight_smile:</span></p>',
